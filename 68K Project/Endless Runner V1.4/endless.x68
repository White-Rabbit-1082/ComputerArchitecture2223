...
* Modified by : Eric Cazacevschi
* Modified Date: 07/03/2023
* Student Number : C00272926
* Date       : 25/02/2023
* Description: Endless Runner Project Starter Kit (Modified By Eric Cazacevschi)
* The Game_Over screen doesnt work , so it just freezes , so in order to play again 
* you have to reload the program
...
COLLISION_CHECK_DONE:               ; No Collision Update points
    ...
    ADD.L   #1, TEMP_SCORE          ; Update New Player Score -------------------------------------------------------------------------------------
    RTS                             ; Return to subroutine

COLLISION:
    BSR     PLAY_HIT                ; Play hit Wav
    SUB.L   #1, LIVES               ; Subtract a Life =============================================================================================
    CMP.L  #0,LIVES                 ; Checks if Lives is equal to 0 -------------------------------------------------------------------------------
    BEQ GAME_OVER                   ; Jump to Game Over if previus statement is true---------------------------------------------------------------
    RTS
